...
def partition(numbers, start, end):
    ...
    for i in range(start, end):
        # o índice será o elemento em análise no momento, ele passará por
        # todos os elementos
        if numbers[i] <= pivot:
...
"""
Normalmente esta ordenação ocorre com complexidade O(n log n),
porém em um pior caso (onde o array está ordenado de forma inversa),
ocorrerá com complexidade O(n²).
"""
